class Aoc04(day: String) : Aoc(day) {
    override fun run() {
        println(solve(readFile(true, true), false))
        println(solve(readFile(false, true), false))
        println(solve(readFile(true, true), true))
        println(solve(readFile(false, true), true))
    }
